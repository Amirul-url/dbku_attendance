...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "dbku_attendance"),
...
BREVO_FROM_NAME = os.environ.get("BREVO_FROM_NAME", "DBKU Attendance")
...
NOTIFICATION_ADMIN_WHATSAPP_NUMBERS = [
    phone.strip()
    for phone in os.environ.get("NOTIFICATION_ADMIN_WHATSAPP_NUMBERS", "").split(",")
    if phone.strip()
]
