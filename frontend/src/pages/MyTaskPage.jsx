      ...
      <div className="table-card my-task-table-card">
        ...
        <DataTable
          ...
          columns={[
            ...
            { key: 'task_title', label: 'Task', render: (row) => <span className="event-assignment-task my-task-table-task"><strong>{row.task_title}</strong><RichTextDisplay value={row.task_description || '-'} className="my-task-table-description" /></span> },
